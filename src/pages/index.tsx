      ...
      <main>
        <Container>
          ...
          <div className='homeGrid'>
            ...
            <Card className='cardMd cardLink' link='https://www.quickval.co'>
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: ".75fr 1fr",
              ...
              >
                <div style={{ marginLeft: "auto", marginRight: "auto" }}>
                  <h2 className='displayHeading'>QuickVal</h2>
                  <p>
                    A platform that helps you validate your product ideas by
                    creating landing pages and accepting payments.
                  </p>
                </div>
                <div className='projectImage'>
                  <img
